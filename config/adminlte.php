        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.2.2/js/buttons.bootstrap4.min.js'
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.2.2/js/buttons.colVis.min.js'
                ],
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/1.11.4/css/dataTables.bootstrap4.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.2.2/css/buttons.bootstrap4.min.css',
                ],
            ],
        ],
        'Select2' => [
